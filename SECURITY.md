...
We take the security of the BadUSB - Payload Builder project seriously. If you discover a security vulnerability, please report it responsibly by following these steps:

1. **Do Not Disclose Publicly**: Avoid disclosing the issue in public forums, such as GitHub issues, until it has been addressed.
2. **Contact the Maintainer**: Send a detailed report to the project maintainer at [@Cynass](https://github.com/justcynass) via GitHub or through other private communication channels (e.g., email, if provided).
3. **Provide Details**:
...
Thank you for helping keep BadUSB - Payload Builder secure!
